...
@section('title') Sign up for FREE access to snapArt @endsection
...
@section('content')
	<div id="signup_messages">
		<h3>Sign up for FREE access to snap<span class="make_it_red">Art</span></h3>
	</div>
	<div id="signup_holder">
		{{ Form::open('users/validation_registration', 'POST', array('id'=>'signup_form')) }}
	  ...
	  <div class="control-group">
    	<div class="controls">
    		<button type="submit" name="submit_registration" id="submit_registration" class="btn bluebutton">Sign up!</button>
    	</div>
    </div>
	</div>
@endsection
